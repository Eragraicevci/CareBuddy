...
export class CheckoutAppointmentTypeComponent implements OnInit {
  ...
  constructor(private checkoutService: CheckoutService, private patientAppointmentService: PatientAppointmentService) { }
  ...
  setAdditionalCostPrice(appointmentType: AppointmentType) {
    this.patientAppointmentService.setAdditionalCostPrice(appointmentType);
  }
